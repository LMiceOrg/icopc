...
lmice_trace_name_t lmice_trace_name[] = {{LMICE_TRACE_INFO, 10, 6, " INFO " /* light_green*/},
                                         {LMICE_TRACE_DEBUG, 11, 7, " DEBUG " /* light_cyan */},
                                         {LMICE_TRACE_WARNING, 14, 9, " WARNING " /*yellow*/},
                                         {LMICE_TRACE_ERROR, 12, 7, " ERROR " /*light_red*/},
                                         {LMICE_TRACE_CRITICAL, 13, 10, " CRITICAL " /* light_purple*/},
                                         {LMICE_TRACE_NONE, 7, 6, "NULL " /* white */},
                                         {LMICE_TRACE_TIME, 14, 6, "TIME " /* yellow*/}};
...
void trace_win32(const char* data, int len) {
    ...
    LMAPI_WIN_COLOR_STDOUT(lmice_trace_name[LMICE_TRACE_DEBUG].name, LMICE_TRACE_DEBUG,
                           lmice_trace_name[LMICE_TRACE_DEBUG].size);
...
lmice_trace_name_t lmice_trace_name[] = {{LMICE_TRACE_INFO, "INFO", "\033[1;32m" /* light_green*/},
...
void wtrace_debug(const wchar_t* format, ...) {
    ...
    WideCharToMultiByte(CP_ACP, 0, wbuff, wcslen(wbuff), buff, sizeof(buff), 0, 0);
